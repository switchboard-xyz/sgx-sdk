use crate::{error::Error, switchboard::AnchorClient, switchboard::Keypair};
...
impl Config {
    pub fn new(
        ...
        //     .map_err(|e| Error::CustomMessage(e.to_string()))?;
        // env.PAYER_SECRET_PATH.clone()
        let payer: Keypair = Arc::new(read_keypair_file(payer_path).unwrap());
